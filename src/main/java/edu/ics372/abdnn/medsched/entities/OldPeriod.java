...
public class OldPeriod extends Entity {
...
//    private State availability;
    ...
    public OldPeriod (int id, int timeslotId, String timeslotName, Department department, LocalDate date, LocalTime startTime, LocalTime endTime) {
        super(id);
...
//    public void setDuration  (Duration duration) { this.duration = duration; }
    ...
    public boolean withinRange (LocalDate startDate, LocalDate endDate, LocalTime beginning, LocalTime end) {
        ...
        beginning = beginning.minusHours(1);
        end = end.plusHours(1);
        return day.isAfter(startDate) && day.isBefore(endDate) && startTime.isAfter(beginning) && end.isBefore(end);
    } //
} // end class Period
